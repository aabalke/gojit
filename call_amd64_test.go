...
func TestSavedRegisters(t *testing.T) {
	...
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&ta))), Rax)
	asm.Mov(Indirect{Rax, 0, 64}, R8)
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&tb))), Rax)
	asm.Mov(Indirect{Rax, 0, 64}, R9)
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&tc))), Rax)
	asm.Mov(Indirect{Rax, 0, 64}, Rsi)
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&td))), Rax)
	asm.Mov(Indirect{Rax, 0, 64}, R10)
	...
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&ta))), Rax)
	asm.Mov(R8, Indirect{Rax, 0, 64})
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&tb))), Rax)
	asm.Mov(R9, Indirect{Rax, 0, 64})
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&tc))), Rax)
	asm.Mov(Rsi, Indirect{Rax, 0, 64})
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&td))), Rax)
	asm.Mov(R10, Indirect{Rax, 0, 64})
	asm.MovAbs(uint64(uintptr(unsafe.Pointer(&te))), Rax)
	asm.Mov(R11, Indirect{Rax, 0, 64})
